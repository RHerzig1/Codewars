...
return (sharkDistance / (sharkSpeed * dolphinVar) > pontoonDistance / youSpeed ? 'Alive!' : 'Shark Bait!')
}

shark(12, 50, 4, 8, true)

// P: Integers and a boolean.
// R: 'Alive!' or 'Shark Bait!'
// E: (12, 50, 4, 8, true) -> 'Alive!'
//    (24, 0, 4, 8, true) -> "Shark Bait!"
// P: Create a formulate that calculates whether or not you make it back to the pontoon. If so, return 'Alive!', else return 'Shark Bait!'.

// let dolphinVar = 1
// if (dolphin === true) {
// dolphinVar = .5
// }
// sharkDistance / (sharkSpeed * dolphinVar) < pontoonDistance / youSpeed