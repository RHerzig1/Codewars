...
// P: Take the string of random letters and split('') it so each letter is an element of an array. Then use the forEach method to replace each letter into a word by assigning it the value of dict['letter']. Then join(' ') the array and return it.
